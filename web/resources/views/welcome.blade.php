              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-6 col-md-5">
                    <div class="about-img">
                      <img src="https://scontent.fbmv1-1.fna.fbcdn.net/v/t39.30808-6/481167110_1418757415760526_7624676283612468753_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeGaGpnuJd4S9beGS1k4GlovwbTprVZZWNLBtOmtVllY0pnaeB0UIO_0V-KqaqH9XS4SYxo-lNzLQLAEoSWGCcBM&_nc_ohc=4MjLNGo9Hw0Q7kNvgG80FxB&_nc_oc=AdhRkSAVr_3GqYX5kirFfybI-tWB10MXO9WZiCQaY4iRIY3JZFLt6f4suliAokqByOM&_nc_zt=23&_nc_ht=scontent.fbmv1-1.fna&_nc_gid=AbqstI3wvVz574gO0K8xTTE&oh=00_AYG47o6bdCUWqk0F9Wfz4eaLzNCB0pNPRFteeIi8Vg_beg&oe=67D9805C" class="img-fluid rounded b-shadow-a" alt="">
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-7">
                    <div class="about-info">
                      <p><span class="title-s">Name: </span> <span>{{ $info['name'] }}</span></p>
                      <p><span class="title-s">Profile: </span> <span>{{ $info['profile'] }}</span></p>
                      <p><span class="title-s">Email: </span> <span>{{ $info['email'] }}</span></p>
                      <p><span class="title-s">Phone: </span> <span>{{ $info['phone'] }}</span></p>
                    </div>
                  </div>
                </div>
                <div class="skill-mf">
...
<script src="{{ asset('asset/lib/popper/popper.min.js') }}"></script>
<script src="{{ asset('asset/lib/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('asset/lib/easing/easing.min.js') }}"></script>
<script src="{{ asset('asset/lib/counterup/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('asset/lib/counterup/jquery.counterup.js') }}"></script>
<script src="{{ asset('asset/lib/owlcarousel/owl.carousel.min.js') }}"></script>
<script src="{{ asset('asset/lib/lightbox/js/lightbox.min.js') }}"></script>
<script src="{{ asset('asset/lib/typed/typed.min.js') }}"></script>
